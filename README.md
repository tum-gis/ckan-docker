...
| [`ckanext-clamav` ](https://github.com/mutantsan/ckanext-clamav) | `v1.1.0` |:heavy_check_mark: | :heavy_check_mark: |CKAN extension that integrates ClamAV antivirus scanning to ensure the security of uploaded files by automatically checking them for malware.|

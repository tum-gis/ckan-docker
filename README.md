...
| [`lhm`](https://github.com/MandanaMoshref/ckanext-lhm) | `2fe46e2` |  |  |  | :heavy_check_mark: | Adds options for a custom metadata schema, custom theming and an adapted set of groups and topics, provided by Landeshauptstadt München (LHM).  |
